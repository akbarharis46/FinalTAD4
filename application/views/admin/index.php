<div id="layoutSidenav_content" style="margin-top: -55px;">
  <main>
    ...
    <div class="container-xl px-4 mt-n10">
      <div class="row">
        <div class="col-xl-4 mb-4">
          ...
          <a class="card lift h-100" href="<?php echo base_url(); ?>UserClient">
        ...
        <div class="col-xl-4 mb-4">
          <!-- Dashboard example card 1-->
          <a class="card lift h-100" href="<?php echo base_url(); ?>BarangClient">
            <div class="card-body d-flex justify-content-center flex-column">
              <div class="d-flex align-items-center justify-content-between">
                <div class="me-3">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-package feather-xl text-primary mb-3">
        ...
        <div class="col-xl-4 mb-4">
          ...
          <a class="card lift h-100" href="<?php echo base_url(); ?>PengirimanClient">
            <div class="card-body d-flex justify-content-center flex-column">
              <div class="d-flex align-items-center justify-content-between">
                <div class="me-3">
                ...
                <img src="<?php echo base_url(); ?>img/pengiriman.png" alt="..." style="width: 8rem">
              </div>
            </div>
          </a>
        </div>
        <div class="col-xl-4 mb-4">
          ...
          <a class="card lift h-100" href="<?php echo base_url(); ?>ProduksiClient">
            <div class="card-body d-flex justify-content-center flex-column">
              <div class="d-flex align-items-center justify-content-between">
                <div class="me-3">
                ...
                <img src="<?php echo base_url(); ?>img/produksi.png" alt="..." style="width: 8rem">
              </div>
            </div>
          </a>
        </div>
            ...
            <div class="col-xl-6 col-xxl-12">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="card bg-secondary text-white" style="height: 50px;">
                    <div class="card-body">
                      <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6><a class="text-dark line-height-normal mb-1" href="<?php echo base_url(); ?>ProduksiClient" style="text-align: top;">Data Produksi</a>
                          <h6>
                  ...
                  <div class="card bg-secondary text-white" style="height: 50px;">
                    <div class="card-body">
                      <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6><a class="text-dark line-height-normal mb-1" href="<?php echo base_url(); ?>DetailProduksiClient" style="text-align: top;">Data Detail Produksi</a>
                          <h6>
                            <div class="d-flex align-items-center flex-shrink-0 me-3">
                              <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="assets/img/illustrations/profiles/profile-1.png" alt=""></div>
                              <div class="d-flex flex-column fw-bold">
                  ...
                  <div class="card bg-secondary text-white" style="height: 50px;">
                    <div class="card-body">
                      <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6><a class="text-dark line-height-normal mb-1" href="<?php echo base_url(); ?>DetailStockProduksiClient" style="text-align: top;">Data Stock Produksi</a>
                          <h6>
                            <div class="d-flex align-items-center flex-shrink-0 me-3">
                              <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="assets/img/illustrations/profiles/profile-1.png" alt=""></div>
                              <div class="d-flex flex-column fw-bold">
                  ...
                  <div class="card bg-secondary text-white" style="height: 50px;">
                    <div class="card-body">
                      <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6><a class="text-dark line-height-normal mb-1" href="<?php echo base_url(); ?>KategoriClient" style="text-align: top;">Data Kategori Barang</a>
                          <h6>
                            <div class="d-flex align-items-center flex-shrink-0 me-3">
                              <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="assets/img/illustrations/profiles/profile-1.png" alt=""></div>
                              <div class="d-flex flex-column fw-bold">
                  ...
                  <div class="card bg-secondary text-white" style="height: 50px;">
                    <div class="card-body">
                      <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6><a class="text-dark line-height-normal mb-1" href="<?php echo base_url(); ?>BarangClient" style="text-align: top;">Data Barang Masuk</a>
                          <h6>
                            <div class="d-flex align-items-center flex-shrink-0 me-3">
                              <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="assets/img/illustrations/profiles/profile-1.png" alt=""></div>
                              <div class="d-flex flex-column fw-bold">
                  ...
                  <div class="card bg-secondary text-white" style="height: 50px;">
                    <div class="card-body">
                      <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6><a class="text-dark line-height-normal mb-1" href="<?php echo base_url(); ?>PengirimanClient" style="text-align: top;">Data Pengiriman</a>
                          <h6>
                            <div class="d-flex align-items-center flex-shrink-0 me-3">
                              <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="assets/img/illustrations/profiles/profile-1.png" alt=""></div>
                              <div class="d-flex flex-column fw-bold">
                  ...
                  <div class="card bg-secondary text-white" style="height: 50px;">
                    <div class="card-body">
                      <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6><a class="text-dark line-height-normal mb-1" href="<?php echo base_url(); ?>DetailClient" style="text-align: top;">Data Detail Pengiriman</a>
                          <h6>
                            <div class="d-flex align-items-center flex-shrink-0 me-3">
                              <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="assets/img/illustrations/profiles/profile-1.png" alt=""></div>
                              <div class="d-flex flex-column fw-bold">
                  ...
                  <div class="col-xl-6 col-xxl-12">
                    ...
                    <div class="card card-header-actions mb-4">
                      <div class="card-header">
                        Projects
                        <a class="btn btn-sm btn-primary-soft text-primary" href="<?php echo base_url(); ?>AdminClient">Create New</a>
                      </div>
                      <div class="card-body">
                        <!-- Progress item 1-->
                ...
                <div class="card">
                  <div class="card-body text-center p-5">
                    ...
                    <a class="btn btn-primary p-3" href="<?php echo base_url(); ?>AdminClient">Upgrade</a>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="container-xl px-4">
      <div class="row">
        ...
        <div class="col-md-6 text-md-end small">
          <a href="<?php echo base_url(); ?>AdminClient">Privacy Policy</a>
          ·
          <a href="<?php echo base_url(); ?>AdminClient">Terms &amp; Conditions</a>
        </div>
      </div>
    </div>
  </footer>
